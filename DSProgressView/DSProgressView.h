 ...
 */
@property (nonatomic, copy) void (^fillChangedBlock)(DSProgressView *progressView, BOOL filled, BOOL animated);
 ...
 *  Example usage would be to invert the colors on your centralView
 */
@property (nonatomic, copy) void (^didSelectBlock)(DSProgressView *progressView);
 ...
 */
@property (nonatomic, copy) void (^progressChangedBlock)(DSProgressView *progressView, CGFloat progress);
