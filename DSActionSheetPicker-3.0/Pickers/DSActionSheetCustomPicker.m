...
#import "DSActionSheetCustomPicker.h"

@interface DSActionSheetCustomPicker ()
@property(nonatomic, strong) NSArray *initialSelections;
@end

@implementation DSActionSheetCustomPicker
...
{
    DSActionSheetCustomPicker *picker = [[DSActionSheetCustomPicker alloc] initWithTitle:title delegate:delegate
                                                                    showCancelButton:showCancelButton origin:origin
