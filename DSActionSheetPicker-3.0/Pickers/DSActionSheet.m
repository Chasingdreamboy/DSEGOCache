...
@interface DSSWActionSheetVC : UIViewController

@property (nonatomic, retain) DSActionSheet *actionSheet;
...
- (UIWindow *)window
{
    ...
    else
    {
        return SWActionSheetWindow = ({
            ...
            window.rootViewController = [DSSWActionSheetVC new];
            window;
        });
    }
}

- (DSSWActionSheetVC *)actionSheetContainer
{
    return (DSSWActionSheetVC *) [self window].rootViewController;
}
...
@implementation DSSWActionSheetVC
...
- (void)setActionSheet:(DSActionSheet *)actionSheet
{
