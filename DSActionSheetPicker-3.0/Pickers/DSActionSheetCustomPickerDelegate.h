...
@protocol DSActionSheetCustomPickerDelegate <UIPickerViewDelegate, UIPickerViewDataSource>
...
- (void)actionSheetPicker:(DSAbstractActionSheetPicker *)actionSheetPicker configurePickerView:(UIPickerView *)pickerView;
 ...
 */
- (void)actionSheetPickerDidSucceed:(DSAbstractActionSheetPicker *)actionSheetPicker origin:(id)origin;

/** Cancel callback.  See actionSheetPickerDidSuccess:origin: */
- (void)actionSheetPickerDidCancel:(DSAbstractActionSheetPicker *)actionSheetPicker origin:(id)origin;
